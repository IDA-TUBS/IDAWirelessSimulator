...
def plot_mtbf_data(data,pdffilename):
    ...
    # y labels
    _label = "$\mathregular{E^{3.5\cdot 10^{-5}}_{fr}=20.9}$"
    _label_optimistic = "$\mathregular{E^{E_b}_{fr}=24.7}$\n"
    y_vector_ticks  = [0,10,20,20.9,24.7,30,40,50,60]
    ...
    ax.set(zticklabels=[_label,3000,2400,1800,1200,600,0.1], zticks=[bound,3000,2400,1800,1200,600,0.1],zlim=(bound,-50))
...
if __name__ == '__main__':
    ...
    plot_mtbf_data(data, "./figures/fig11_DDSMeanTimeBetweenFailures.pdf")
